...
ggsave(filename= 'Fig_S6A.tif', dpi=400, width=15, height = 17, units = 'cm')
ggsave(filename= 'Fig_S6A.png', dpi=400, width=15, height = 17, units = 'cm')
...
setwd(here())
setwd('results/Figures')
ggsave(filename= 'fig_4A.tif', dpi=400, width=18, height = 10, units = 'cm')
ggsave(filename= 'fig_4A.png', dpi=400, width=18, height = 10, units = 'cm')
